...
class OutputComments extends React.Component<OutputCommentsProps, OutputCommentsState> {
    ...
    render() {
        ...
        return (
            <div>
                <Typography.Title level={3} className="text-3xl font-bold mb-2 mt-2 me-2 title-text">Comments</Typography.Title>
                <TextArea
                    rows={4}
                    value={review}
                ...
                />
                <div style={{ marginBottom: '16px' }} className='d-flex align-items-center'>
                    <Typography.Title level={4} className="text-3xl font-bold mb-2 mt-2 me-2 title-text">Rating: </Typography.Title>
